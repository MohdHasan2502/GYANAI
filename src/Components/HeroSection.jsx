  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center space-y-6">
        {/* 🔠 Animated Heading */}
        <motion.h1
          className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight text-gray-900 dark:text-white min-h-[100px]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          Get <span className="font-bold text-purple-600 dark:text-purple-400">personalized suggestions</span>, use <span className="font-bold text-blue-600 dark:text-blue-400">voice chat</span>, and never miss a scheme with <span className="font-bold text-pink-600 dark:text-pink-400">smart reminders</span>.
        </motion.p>
